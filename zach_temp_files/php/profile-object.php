...
$profile = new Profile (null, 2, "PRZ", "MediaSTORM");
...
// now that PHP knows waht to build, we use the new keyword to creae an object
// the new keyword automatically runs the __construct method
...
//
//
//// var_dump to have a look at the resulting object that has just been instantiated
var_dump($profile);
?>
